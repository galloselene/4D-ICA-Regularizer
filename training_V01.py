...
# when using nn.CrossEntropyLoss() 
        ...
        update_orig_weight(net, ica_matrix.cuda(), lr=0.00001)
...
#### plot realtime
    update_visdom_plot(loss_window, accuracy_window, epoch_i, epoch_train_loss.cpu(), val_loss.cpu(), bal_acc, val_bal_acc)
